...
You can pass multiple key, value pairs separated by comma and provide arrays for both modelname and methodname. let me show you:
...
<pre>
  ...
  class Comment < ActiveRecord::Base
    ...
    getter_for :user => :department         # => comment.user_department
    getter_for :user_department => :name    # => comment.user_department_name
  end
